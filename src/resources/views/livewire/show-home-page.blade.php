            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="section-title pt-4">
                        <p class="text-primary text-uppercase fw-bold mb-3">Crafted for Creators</p>
                        <h1>Bringing Back the Magic of the Moment</h1>
                        <p>"Discover camera services tailored for every storyteller — effortless, secure, and ready
